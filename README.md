...
├── tools/                   # Recommended subdirectory for @tool functions
├── resources/               # Recommended subdirectory for @resource functions
├── prompts/                 # Recommended subdirectory for @prompt functions
├── internals/                 
    └── services             # services for handlers ^^^^ by type in subdir	
├── tests/
